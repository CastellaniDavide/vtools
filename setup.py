...
setup(
      name='vtools',
      version=get("https://api.github.com/repos/CastellaniDavide/vtools/tags").json()[0]['name'].replace("v", "") if len(get("https://api.github.com/repos/CastellaniDavide/vtools/tags").json()) > 0 else "1.0", # Lastest release
